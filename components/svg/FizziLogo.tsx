...
export function FizziLogo(props: SVGProps<SVGSVGElement>) {
  ...
  const titleId = `${id}-fizzi-logo-title`;
  const maskId = `${id}-fizzi-logo-mask`;
  const strokeMaskId = `${id}-fizzi-logo-stroke-mask`;
  const clipPathId = `${id}-fizzi-logo-clip`;
