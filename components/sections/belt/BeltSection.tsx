...
export default function BeltSection() {
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-[#FDE047]">
      ...
      <div className="circles absolute left-[8%] top-[15%] h-24 w-24 rounded-full border-12 border-[#18243D]/10" />

      <div className="circles absolute bottom-[12%] right-[10%] h-40 w-40 rounded-full border-16 border-[#18243D]/10" />
      ...
      <div className="belt absolute top-[53%] left-[-25vw] z-10 h-18 w-[150vw] -rotate-12 overflow-hidden border-y-4 border-[#FFF8E7]/20 bg-[#52b717] shadow-[0_20px_40px_rgba(0,0,0,0.15)] lg:top-[58%] lg:h-28">
      ...
      <div className="absolute right-1/2 bottom-10 flex translate-x-1/2 md:translate-x-3/5 md:-bottom-50 lg:-right-50 lg:translate-x-0">
